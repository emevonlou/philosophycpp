...
int main()
{
    ...
    cout << "Ambos são temporários da maneira mais ligeira." << endl << endl;
    cout << "Três: Quando perguntado se você se importa com o mundo..." << endl;
    cout << "Olhe fundo dentro daquele que o perguntou." << endl;
    cout << "Ele não perguntará novamente." << endl << endl;
    cout << "Quatro: Nunca dê seu nome verdadeiro." << endl << endl;
